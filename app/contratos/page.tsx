...
export default function AreaContratos() {
  return (
    <div className="hc-dark flex min-h-[100dvh] flex-1 flex-col">
      <FundoEscuro />
      <div className="hc-gold-rule" />
      <GuardaSetor papeis={["contratos", "admin_dpo"]} nome="Gestão de Contratos">
        ...
        <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-8">
          <section className="hc-fade-up text-center">
            <span className="hc-badge">Gestão de Contratos</span>
            <h1 className="mt-5 font-serif text-4xl font-semibold text-[var(--hc-ink)] sm:text-5xl">Gestão de Contratos</h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-[var(--hc-ink-soft)]">
              Bem-vindo(a). Esta área está <strong>em construção</strong> — em breve a organização de contratos
              e documentos do hospital estará disponível aqui.
            </p>
          </section>
          ...
          <div className="hc-card hc-gold-frame mt-8 p-8 text-center">
            ...
            <p className="mt-4 text-[var(--hc-ink-soft)]">Nos diga como será o fluxo de contratos e nós montamos.</p>
          </div>
        </main>
      </GuardaSetor>
