...
export default function AreaCobranca() {
  return (
    <>
      <FundoSuave />
      <div className="hc-gold-rule" />
      <GuardaSetor papeis={["cobranca", "admin_dpo"]} nome="Cobrança">
        ...
        <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-8">
          <section className="hc-fade-up text-center">
            <span className="hc-badge">Setor Cobrança</span>
            <h1 className="mt-5 font-serif text-4xl font-semibold text-[var(--hc-ink)] sm:text-5xl">Cobrança</h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-[var(--hc-ink-soft)]">
              Bem-vindo(a). Esta área está <strong>em construção</strong> — em breve as funções de cobrança e
              recebimentos estarão disponíveis aqui.
            </p>
          </section>
          ...
          <div className="hc-card hc-gold-frame mt-8 p-8 text-center">
            ...
            <p className="mt-4 text-[var(--hc-ink-soft)]">Nos diga como será o fluxo de cobrança e nós montamos.</p>
          </div>
        </main>
      </GuardaSetor>
