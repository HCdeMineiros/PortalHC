...
export default function AreaLimpeza() {
  return (
    <>
      <FundoSuave />
      <div className="hc-gold-rule" />
      <GuardaSetor papeis={["limpeza", "admin_dpo"]} nome="Manutenção de limpeza">
        ...
        <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-8">
          <section className="hc-fade-up text-center">
            <span className="hc-badge">Setor Manutenção de limpeza</span>
            <h1 className="mt-5 font-serif text-4xl font-semibold text-[var(--hc-ink)] sm:text-5xl">Manutenção de limpeza</h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-[var(--hc-ink-soft)]">
              Bem-vindo(a). Esta área está <strong>em construção</strong> — em breve as funções de manutenção e
              limpeza estarão disponíveis aqui.
            </p>
          </section>
          ...
          <div className="hc-card hc-gold-frame mt-8 p-8 text-center">
            ...
            <p className="mt-4 text-[var(--hc-ink-soft)]">Nos diga como será o controle de limpeza e nós montamos.</p>
          </div>
        </main>
      </GuardaSetor>
