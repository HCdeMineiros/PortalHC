# CISTOLITOTOMIA (RETIRADA DE CÁLCULO DA BEXIGA)

> Fonte: 05_CISTOLITOTOMIA.docx · termo_consentimento · ASSINATURA · 44 parágrafos

3. O QUE É O PROCEDIMENTO

A cistolitotomia é a remoção cirúrgica de cálculo(s) (pedras) localizado(s) no interior da bexiga, realizada por meio de incisão na região suprapúbica (baixo ventre), com abertura da bexiga (cistotomia), retirada dos cálculos e fechamento por sutura. Ao final, é mantida sonda vesical por alguns dias, para cicatrização adequada da bexiga.

4. INDICAÇÕES

Cálculos vesicais volumosos ou múltiplos, não passíveis de tratamento endoscópico, frequentemente associados a obstrução urinária (como crescimento da próstata), infecções de repetição ou corpos estranhos. Quando associada a fator obstrutivo, o tratamento da causa pode ser indicado no mesmo ato ou em momento posterior.

5. ANESTESIA

Raquianestesia (bloqueio espinhal) ou anestesia geral, conforme avaliação do anestesiologista. A avaliação pré-anestésica e o esclarecimento dos riscos próprios da anestesia serão realizados por médico anestesiologista, sendo objeto de termo de consentimento específico.
...
Sangramento urinário (hematúria) transitório;

Infecção urinária e infecção da ferida operatória;

Fístula urinária (vazamento de urina pela ferida), em regra tratada com manutenção da sonda vesical por período prolongado;

Retenção urinária após a retirada da sonda;

Lesão de estruturas vizinhas (alças intestinais, peritônio), rara;

Recidiva (nova formação de cálculos), sobretudo se não tratada a causa de base (obstrução, infecção);

Necessidade de manutenção de sonda vesical e de cistografia de controle antes de sua retirada, conforme critério médico.

8. ALTERNATIVAS TERAPÊUTICAS

Tratamento endoscópico (cistolitotripsia — fragmentação do cálculo por via uretral), viável para cálculos menores; litotripsia extracorpórea em casos selecionados. A não remoção dos cálculos perpetua infecções, sangramentos e risco de lesão vesical crônica.

9. CUIDADOS E RECOMENDAÇÕES PÓS-OPERATÓRIAS

Cuidados com a sonda vesical e o coletor, hidratação abundante, antibiótico conforme prescrição e retorno para retirada da sonda. Sinais de alerta: febre, urina com sangramento intenso, dor abdominal progressiva e saída de urina pela ferida.
...
Assim, de forma LIVRE, CONSCIENTE e ESCLARECIDA, AUTORIZO a realização do procedimento CISTOLITOTOMIA (RETIRADA DE CÁLCULO DA BEXIGA), pela equipe acima identificada, nas dependências do Hospital das Clínicas de Mineiros Ltda.
