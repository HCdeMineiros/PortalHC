# HERNIORRAFIA / HERNIOPLASTIA INGUINAL BILATERAL

> Fonte: 09_HERNIA_INGUINAL_BILATERAL.docx · termo_consentimento · ASSINATURA · 44 parágrafos

3. O QUE É O PROCEDIMENTO

Correção cirúrgica, em um mesmo ato operatório, de hérnias inguinais presentes em ambos os lados da região da virilha. O procedimento é realizado por incisões em cada região inguinal (ou por videolaparoscopia, quando indicado), com redução do conteúdo herniado, tratamento dos sacos herniários e reforço da parede com colocação de tela cirúrgica bilateralmente. A correção simultânea evita duas internações e duas anestesias, porém implica tempo cirúrgico maior e desconforto pós-operatório em ambos os lados.

4. INDICAÇÕES

Hérnias inguinais bilaterais sintomáticas ou com risco de complicação (encarceramento/estrangulamento). A correção em tempo único é, em regra, segura e vantajosa, conforme avaliação individual.
...
Os mesmos riscos da correção unilateral, potencialmente em ambos os lados: recidiva, dor inguinal crônica, hematoma, seroma, infecção de ferida ou da tela;

No homem: lesão de estruturas do cordão espermático, orquite isquêmica e atrofia testicular (raras), com possível repercussão na fertilidade — risco presente em cada um dos lados operados;

Alterações de sensibilidade nas regiões operadas;

Maior tempo cirúrgico e anestésico em comparação à correção unilateral;

Retenção urinária no pós-operatório imediato, mais frequente em correções bilaterais;

Edema e equimose (roxidão) escrotal ou dos grandes lábios;

Lesão de estruturas vizinhas (rara).

8. ALTERNATIVAS TERAPÊUTICAS

Correção em dois tempos cirúrgicos distintos (um lado de cada vez); correção videolaparoscópica (TEP/TAPP), que permite tratar ambos os lados pelos mesmos portais, conforme disponibilidade e indicação.

9. CUIDADOS E RECOMENDAÇÕES PÓS-OPERATÓRIAS

Evitar esforços físicos e levantamento de peso pelo período orientado (em regra 30 dias), analgesia, cuidados com as feridas e retorno ambulatorial. Sinais de alerta: dor intensa, aumento de volume local, febre, vermelhidão e secreção nas feridas.
...
Assim, de forma LIVRE, CONSCIENTE e ESCLARECIDA, AUTORIZO a realização do procedimento HERNIORRAFIA / HERNIOPLASTIA INGUINAL BILATERAL, pela equipe acima identificada, nas dependências do Hospital das Clínicas de Mineiros Ltda.
