# COLECISTECTOMIA CONVENCIONAL — ABERTA (RETIRADA DA VESÍCULA BILIAR)

> Fonte: 06_COLECISTECTOMIA_ABERTA.docx · termo_consentimento · ASSINATURA · 45 parágrafos

3. O QUE É O PROCEDIMENTO

A colecistectomia é a remoção cirúrgica da vesícula biliar, órgão que armazena a bile produzida pelo fígado. Na técnica aberta (convencional), é realizada por incisão no abdome superior direito (subcostal), com identificação e ligadura da artéria cística e do ducto cístico e retirada da vesícula. Conforme os achados, pode ser necessária colangiografia intraoperatória (radiografia contrastada das vias biliares) e exploração do ducto colédoco para retirada de cálculos, com eventual colocação de dreno.

4. INDICAÇÕES

Colelitíase (pedras na vesícula) sintomática, colecistite aguda ou crônica (inflamação/infecção da vesícula), pólipos com critérios de risco, pancreatite biliar e outras condições, conforme avaliação médica. A vesícula não é órgão essencial e sua retirada é compatível com vida e digestão normais.
...
Lesão das vias biliares (ducto colédoco/hepático), complicação rara porém grave, que pode exigir reparo complexo, novos procedimentos ou reoperação;

Fístula biliar (vazamento de bile), podendo exigir drenagem e procedimentos endoscópicos;

Cálculo residual no colédoco (coledocolitíase residual), com necessidade de tratamento endoscópico posterior (CPRE);

Sangramento, inclusive do leito hepático;

Infecção da ferida operatória e coleções intra-abdominais;

Hérnia incisional na cicatriz;

Lesão de órgãos vizinhos (duodeno, cólon, fígado), rara;

Síndrome pós-colecistectomia (sintomas digestivos persistentes, como diarreia transitória).

8. ALTERNATIVAS TERAPÊUTICAS

Colecistectomia videolaparoscópica, quando tecnicamente viável; tratamento clínico paliativo dos sintomas, que não elimina os cálculos nem o risco de complicações graves (colecistite, pancreatite, icterícia obstrutiva).

9. CUIDADOS E RECOMENDAÇÕES PÓS-OPERATÓRIAS

Dieta progressiva com orientação alimentar, analgesia, cuidados com a ferida e eventual dreno, e retorno ambulatorial. Sinais de alerta: icterícia (pele/olhos amarelados), febre, dor intensa, vômitos persistentes e secreção pela ferida.
...
Assim, de forma LIVRE, CONSCIENTE e ESCLARECIDA, AUTORIZO a realização do procedimento COLECISTECTOMIA CONVENCIONAL — ABERTA (RETIRADA DA VESÍCULA BILIAR), pela equipe acima identificada, nas dependências do Hospital das Clínicas de Mineiros Ltda.
