...
/**
 * Botão premium "Acesso da Equipe" — mesmo formato do botão do médico.
 * variant "light": fundo claro. variant "glass": sobre o hero escuro.
 */
export function BotaoEquipe({
  ...
  return (
    ...
    >
      <span className="flex h-16 w-16 flex-none items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--hc-red)] to-[var(--hc-red-700)] text-[1.7rem] leading-none text-white shadow-[inset_0_1px_0_rgba(255,255,255,.35),0_6px_16px_-6px_rgba(160,12,34,.6)]">
        🏥
      </span>
